...
export default function ClientShowtimeManager({ cinemas, movies, rooms }: { cinemas: any[], movies: any[], rooms: any[] }) {
  const [loading, setLoading] = useState(false)
  
  const handleAction = async (action: Function, formData: FormData, formRef: React.RefObject<HTMLFormElement>) => {
    setLoading(true)
